...
try {
    ...
    // 1. Check if username is already taken in the active users table
    ...
    // 2. Check if username already has a PENDING sign-up request.
    // Note: Approved/Rejected historical records do NOT block re-registration.
